...
The key insight is that MAC layer broadcast scalability in infrastructure free networks can be significantly improved through simple adaptation. Global coordination, channel measurements, or cross layer optimization are not necessary for substantial gains.

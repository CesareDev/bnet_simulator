...
These system are designed for emergency situations only, not for routine proximity detection: false alarms lead significant costs and legal consequences. The satellite relay introduces delays of several minutes, which is far too slow for collision avoidance. Additionally, these devices transmit to satellites but do not provide local awareness to the other crafts.
